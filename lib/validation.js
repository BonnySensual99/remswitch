...
function normalizeSettings(input, defaults) {
    ...
    return {
        ...
        autoPlayPreDelayMs: clampNumber(value.autoPlayPreDelayMs, defaults.autoPlayPreDelayMs || 1500, 100, 5000),
        autoPlayTabs: clampNumber(value.autoPlayTabs, defaults.autoPlayTabs || 19, 1, 100),
        autoPlayTabDelayMs: clampNumber(value.autoPlayTabDelayMs, defaults.autoPlayTabDelayMs || 50, 0, 500),

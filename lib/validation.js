...
function normalizeSettings(input, defaults) {
    ...
    return {
        ...
        fieldDelayMs: clampNumber(value.fieldDelayMs, defaults.fieldDelayMs, 50, 1000), defaults.autoPlayPreDelayMs || 1500, 100, 5000), defaults.autoPlayTabs || 19, 1, 100), defaults.autoPlayTabDelayMs || 50, 0, 500),
